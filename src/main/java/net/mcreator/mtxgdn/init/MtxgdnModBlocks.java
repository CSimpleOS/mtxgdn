...
import net.mcreator.mtxgdn.block.JieziPlatformBlock;
...
public class MtxgdnModBlocks {
	...
	public static final RegistryObject<Block> JIEZI_PLATFORM = REGISTRY.register("jiezi_platform", () -> new JieziPlatformBlock());
}
