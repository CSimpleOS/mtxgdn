...
public abstract class WhiteArmorItem extends ArmorItem {
	public WhiteArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(MtxgdnModItems.WHITE.get()));
			}
	...
	public static class Helmet extends WhiteArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mtxgdn:textures/models/armor/white_layer_1.png";
		}
	}
	...
	public static class Leggings extends WhiteArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mtxgdn:textures/models/armor/white_layer_2.png";
		}
	}

	public static class Boots extends WhiteArmorItem {
		public Boots() {
